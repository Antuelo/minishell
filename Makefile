...
SRCS =	 main.c \
		...
		src/executions/execute_pipeline.c src/executions/is_builtin_exec.c src/executions/is_builtin_exec1.c\
		src/executions/is_builtin_exec2.c src/executions/is_builtin_exec3.c src/executions/is_builtin_exec4.c\
